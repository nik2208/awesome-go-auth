...
c.SetCookie(&http.Cookie{Name: "access_token", Value: "", Path: "/", HttpOnly: true, MaxAge: -1})
c.SetCookie(&http.Cookie{Name: "refresh_token", Value: "", Path: "/", HttpOnly: true, MaxAge: -1})
...
c.SetCookie(&http.Cookie{Name: "access_token", Value: tokens.AccessToken, Path: "/", HttpOnly: true, SameSite: http.SameSiteLaxMode, Expires: expires})
c.SetCookie(&http.Cookie{Name: "refresh_token", Value: tokens.RefreshToken, Path: "/", HttpOnly: true, SameSite: http.SameSiteLaxMode})
}
